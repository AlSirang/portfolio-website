export const jobHistories = [
  {
    ...
    description:
      'As Co-Founder and MERN developer, I oversee the management and development of websites, including decentralized platforms. My role involves strategic leadership and hands-on coding to ensure the effective implementation of web solutions for projects.',
    tools: [
      'JavaScript',
      'TypeScript',
      'Solidity',
  ...
  },
  {
    ...
    role: 'MERN Developer | Solidity Developer',
    company: 'Webloop Technologies Pvt. Ltd',
    description:

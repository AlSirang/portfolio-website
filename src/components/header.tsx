  ...
  return (
    <header className='lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24 lg:items-end'>
      <div>
        ...
        <h1 className='text-4xl font-bold tracking-tight text-slate-200 sm:text-5xl mt-3'>
      ...
      <ul className='ml-1 mt-8 flex items-center' aria-label='Social media'>
        <li className='mr-5 text-xs'>
          <SocialLink href='https://github.com/AlSirang' social='Github'>
            <svg
        ...
        <li className='mr-5 text-xs'>
          <SocialLink href='https://twitter.com/alsirang' social='Twitter'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              viewBox='0 0 248 204'
              fill='currentColor'
        ...
        <li className='mr-5 text-xs'>
          <SocialLink href='https://www.linkedin.com/in/ba-shir' social='LinkedIn'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              viewBox='0 0 24 24'
              fill='currentColor'
